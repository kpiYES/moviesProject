...
public class GenreRepositoryImpl implements GenreRepository {
    ...
    // do not use '*' use actual column names
    private static final String GET_ALL_QUERY = "SELECT * FROM moviesproject.genre ORDER BY type_of_genre";
    ...
    public Genre create(Genre genre) {
        try (Connection connection = DBManager.getConnect();
            ...
            if (resultSet.next()) {
                long generatedId = resultSet.getLong(1);// generated by database
                genre.setId(generatedId);
            }

            return genre; // return fully assembled genre with id
        } catch (SQLException e) {
